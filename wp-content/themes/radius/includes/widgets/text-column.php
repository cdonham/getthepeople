...
?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('column_icon'); ?>"><?php _e('Column Icon (Please visit http://fontsquirrel.com/fonts/entypo to pick an icon. Enter the letter of the icon you would like to use.)','slate'); ?> 
