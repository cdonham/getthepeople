<div id="container">
    <?php if (trim($postMeta['unique']['headerImage']) != '' AND file_exists(DOCUMENT_ROOT.'/'.PLUGIN_URL.'/uploads/'.$postMeta['unique']['headerImage'])) { ?>
        <div id="headerImage">
    ...
    <div id="content">
        ...
        if ($postMeta['shared']['optInProvider'] != '(none)') require_once(PLUGIN_ROOT.'/views/optin.php'); 
        ?>
    ...
    <?php if (trim($postMeta['unique']['footerImage']) != '' AND file_exists(DOCUMENT_ROOT.'/'.PLUGIN_URL.'/uploads/'.$postMeta['unique']['footerImage'])) { ?>
        <div id="footerImage">
